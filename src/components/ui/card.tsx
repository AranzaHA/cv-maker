...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-sm font-semibold text-[#26215C] group-data-[size=sm]/card:text-sm dark:text-[#F5F3FF]",
        className
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-xs/relaxed text-[#6B6893] dark:text-[#AFA9EC]", className)}
      {...props}
    />
  )
}
